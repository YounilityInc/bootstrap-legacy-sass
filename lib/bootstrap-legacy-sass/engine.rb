module BootstrapLegacy
  module Rails
    class Engine < ::Rails::Engine
      initializer 'bootstrap-legacy-sass.assets.precompile' do |app|
        ...
        unless Sprockets::Rails::VERSION.split('.', 2)[0].to_i >= 3
          app.config.assets.precompile << %r(bootstrap-legacy/glyphicons-halflings-regular\.(?:eot|svg|ttf|woff2?)$)
        end
      end
    end
  end
